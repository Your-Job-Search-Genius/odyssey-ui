    ...
    return (
        ...
        >
            <FormField control={form.control} name="email">
                {({ field, fieldState }) => (
                    <Input {...field} isRequired isInvalid={fieldState.invalid} hint={fieldState.error?.message} label="Email" placeholder="you@company.com" type="email" />
                )}
            </FormField>
    ...
    return (
        ...
        >
            ...
            <FormField control={form.control} name="bio">
                {({ field, fieldState }) => (
                    <TextArea {...field} isInvalid={fieldState.invalid} hint={fieldState.error?.message} label="Bio" placeholder="Tell us about yourself" rows={3} />
                )}
            </FormField>
